  ...
  return (
    <div className="mx-auto max-w-[1080px]">
            ...
            {filtered.map((b) => {
              ...
              return (
                <article key={b.id} className="bg-cream neu-raised rounded-[24px] p-5">
                  ...
                  <p className="text-ink-muted mt-1 text-[0.72rem]">{b.subjectIds.map(subjectName).join(', ')} · {b.pages} pp · {b.year}</p>
                        ...
                        <td className={tdCls}>
                          <div className="flex gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-ink-muted text-[0.72rem]">{b.pages} pp · {b.year} · {b.publisher || sType}</p>
                            </div>
                          </div>
                        </td>
                        <td className={tdCls}>
      ...
      <ConfirmDialog
        ...
        body={remove ? `“${remove.title}” will leave the desk. The external file (${remove.sourceType ?? 'archive'}) is not deleted.` : ''}
